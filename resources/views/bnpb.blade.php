...
<body id="top">
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <ul class="header-nav__list">
                    ...
                    <li><a href="/aktivitas">Cari Aktivitas</a></li>
                    <li><a href="/bencana">Cari Bencana</a></li>
                    <li><a href="/formAktivitas">Tambah Aktivitas</a></li>
                    <li><a href="/formBencana" title="contact">Tambah Bencana</a></li>
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
        ...
        <ul class="home-sidelinks">
            ...
            <li><a class="smoothscroll" href="#services">Tentang kami<span>UNLIMITED</span></a></li>
    ...
    <section id='services' class="s-services light-gray">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1">UNLIMITED. Terdiri dari 3 Developer hebat dan ingin membantu sesama manusia.</h1>
            </div>
        </div> <!-- end section-header -->
            ...
            <div class="row testimonials">
                ...
                <div class="col-full testimonials__slider">
                    ...
                    <div class="testimonials__slide">
                        ...
                        <p>Lahir di Pekanbaru , tinggal dan besar dikota Pekanbaru,Riau. Hoby Futsal dan Sepakbola ,sekarang menjalani studi Teknik Informatika di Universitas Islam Indonesia.</p>
                        <div class="testimonials__author">
                            Andres Mondaref Jon
                            <span>Front-end</span>
                        </div>
